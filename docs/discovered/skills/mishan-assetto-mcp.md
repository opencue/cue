---
title: "mishan/assetto-mcp — Claude Code skill discovered by cue"
description: "An MCP for Assetto Corsa"
layout: page
updated: 2026-09-10
tags: [claude-code, skill, core]
---

# ✨ [mishan/assetto-mcp](https://github.com/mishan/assetto-mcp)

**★ 0** · strong (score 5) · Python · assetto-corsa, assettocorsa, mcp-server

> An MCP for Assetto Corsa
...
- 🏷️ Tags: assetto-corsa, assettocorsa, mcp-server
...
cue skills add mishan/assetto-mcp --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/mishan/assetto-mcp)

---
title: "fedonman/osct — Claude Code skill discovered by cue"
description: "Highly opinionated workflows for contributing to and maintaining open-source projects."
layout: page
updated: 2026-09-10
tags: [claude-code, skill, core]
---

# ✨ [fedonman/osct](https://github.com/fedonman/osct)

**★ 0** · strong (score 6) · Python · claude-code-skill, codex-skill, open-source-maintenance

> Highly opinionated workflows for contributing to and maintaining open-source projects.
...
- 🏷️ Tags: claude-code-skill, codex-skill, open-source-maintenance
...
cue skills add fedonman/osct --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/fedonman/osct)

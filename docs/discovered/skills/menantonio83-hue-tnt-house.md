---
title: "menantonio83-hue/tnt-house — Claude Code skill discovered by cue"
description: "TNT House - Safe New Tokens Platform"
layout: page
updated: 2026-09-10
tags: [claude-code, skill, core]
---

# ✨ [menantonio83-hue/tnt-house](https://github.com/menantonio83-hue/tnt-house)

**★ 0** · strong (score 5) · TypeScript · ai-agents, dsh-plugin, mcp-server, risk-scoring, solana
...
- 🏷️ Tags: ai-agents, dsh-plugin, mcp-server, risk-scoring, solana
...
cue skills add menantonio83-hue/tnt-house --profile core
```
...
[← back to all profiles](../index.md) · [view repo on GitHub →](https://github.com/menantonio83-hue/tnt-house)
